...
* 悬浮球允许用户自由拖拽；拖拽过程中应保持在当前屏幕可视区域内自由移动，不自动贴边。只有当用户松开鼠标时，若悬浮球已接近当前屏幕的可用边缘，才触发吸附与短时弹性停靠动画；若同时接近横向与纵向边缘，则应直接吸附到对应角落（左上 / 右上 / 左下 / 右下）。若松手位置未进入吸附阈值，则保持在松手位置，不得自行贴边。左右贴边可继续保留较深的半隐藏效果；上下与四角贴边则不应简单复用“藏一半”的规则，顶部与上角停靠时需要保留脸部与冠羽可见，底部与下角停靠时也应至少保留脸部主体可见。
