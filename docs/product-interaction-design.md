...
* 悬浮球允许用户自由拖拽；拖拽过程中可短暂贴近或越过屏幕边缘，但在用户松开鼠标后应可吸附到当前屏幕的可用边缘（上 / 下 / 左 / 右），不得停留在屏幕边界之外。
...
当用户拖拽悬浮球、悬浮球向上 / 下 / 左 / 右任一边缘自动贴边，或屏幕约束导致气泡需要换边时，气泡应以短时、平滑的位移动画完成换位，而不是突然跳变到新的停靠位置。
