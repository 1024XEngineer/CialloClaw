...
export default function Galaxy({
  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      if (mouseUniform?.value) {
        mouseUniform.value[0] = smoothMousePos.current.x;
        mouseUniform.value[1] = smoothMousePos.current.y;
      }

      if (program.uniforms.uMouseActiveFactor) {
  ...
  return <div ref={ctnDom} className="relative h-full w-full" />;
}
