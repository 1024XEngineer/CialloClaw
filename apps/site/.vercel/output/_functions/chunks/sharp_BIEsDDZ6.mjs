import { A as AstroError, n as MissingSharp } from './entrypoint_Dr6BAJNe.mjs';
import { b as baseService, p as parseQuality } from './generic_D4QGqCsP.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BllbKySR.mjs').then(n => n.i)).default;
  } catch {
