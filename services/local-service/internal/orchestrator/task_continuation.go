...
type taskContinuationOptions struct {
	...
	// AllowAsyncBubble keeps the desktop bubble continuation hotfix limited to the
	// floating-ball submit path that already opted into immediate async delivery.
