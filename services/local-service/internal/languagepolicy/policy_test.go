...
func TestIsEnglishOnlyText(t *testing.T) {
	tests := []struct {
		...
		{name: "english_open_docs", text: "open docs", want: true},
		{name: "english_good_morning", text: "good morning", want: true},
		{name: "english_rename_utils_folder", text: "rename utils folder", want: true},
		...
		{name: "english_yes", text: "yes", want: true},
		{name: "english_no", text: "no", want: true},
		{name: "english_ready", text: "ready", want: true},
		{name: "english_im_ready", text: "I'm ready", want: true},
		{name: "english_smart_apostrophe_ready", text: "I" + "\u2019" + "m ready", want: true},
		{name: "english_lgtm", text: "LGTM", want: true},
		{name: "english_thx", text: "thx", want: true},
		{name: "english_ship_it", text: "ship it", want: true},
		{name: "english_release_checklist", text: "release checklist", want: true},
		{name: "english_thanks_emoji", text: "thanks 👍", want: true},
